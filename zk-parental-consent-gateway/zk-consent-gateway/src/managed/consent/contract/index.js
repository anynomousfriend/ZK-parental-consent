...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      grant_consent: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('grant_consent',
                                     ...
                                     'consent.compact line 13 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
      ...
      revoke_consent: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('revoke_consent',
                                     'argument 1 (as invoked from Typescript)',
                                     'consent.compact line 24 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(child_id_hash_0) === 'bigint' && child_id_hash_0 >= 0 && child_id_hash_0 <= __compactRuntime.MAX_FIELD)) {
      ...
      verify_minor_access: (...args_1) => {
        ...
        const child_id_hash_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('verify_minor_access',
                                     'argument 1 (as invoked from Typescript)',
                                     'consent.compact line 36 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(child_id_hash_0) === 'bigint' && child_id_hash_0 >= 0 && child_id_hash_0 <= __compactRuntime.MAX_FIELD)) {
        ...
        const result_0 = this._verify_minor_access_0(context,
                                                     partialProofData,
                                                     child_id_hash_0);
  ...
  _verify_minor_access_0(context, partialProofData, child_id_hash_0) {
    const disclosed_hash_0 = child_id_hash_0;
    const is_authorized_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                                                                                       { idx: { cached: false,
