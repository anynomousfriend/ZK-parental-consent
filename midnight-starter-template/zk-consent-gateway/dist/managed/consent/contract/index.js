...
export class Contract {
    ...
    constructor(...args_0) {
        ...
        this.circuits = {
            grant_consent: (...args_1) => {
                if (args_1.length !== 2) {
                    throw new __compactRuntime.CompactError(`grant_consent: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
                }
                const contextOrig_0 = args_1[0];
                const child_id_hash_0 = args_1[1];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('grant_consent', 'argument 1 (as invoked from Typescript)', 'consent.compact line 16 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(typeof (child_id_hash_0) === 'bigint' && child_id_hash_0 >= 0 && child_id_hash_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('grant_consent', 'argument 1 (argument 2 as invoked from Typescript)', 'consent.compact line 16 char 1', 'Field', child_id_hash_0);
                }
                ...
                const result_0 = this._grant_consent_0(context, partialProofData, child_id_hash_0);
            ...
            revoke_consent: (...args_1) => {
                ...
                const child_id_hash_0 = args_1[1];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('revoke_consent', 'argument 1 (as invoked from Typescript)', 'consent.compact line 30 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(typeof (child_id_hash_0) === 'bigint' && child_id_hash_0 >= 0 && child_id_hash_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('revoke_consent', 'argument 1 (argument 2 as invoked from Typescript)', 'consent.compact line 30 char 1', 'Field', child_id_hash_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
            ...
            verify_minor_access: (...args_1) => {
                ...
                const child_id_hash_0 = args_1[1];
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('verify_minor_access', 'argument 1 (as invoked from Typescript)', 'consent.compact line 42 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(typeof (child_id_hash_0) === 'bigint' && child_id_hash_0 >= 0 && child_id_hash_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('verify_minor_access', 'argument 1 (argument 2 as invoked from Typescript)', 'consent.compact line 42 char 1', 'Field', child_id_hash_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
                ...
                const result_0 = this._verify_minor_access_0(context, partialProofData, child_id_hash_0);
    ...
    _grant_consent_0(context, partialProofData, child_id_hash_0) {
    ...
    _verify_minor_access_0(context, partialProofData, child_id_hash_0) {
        const disclosed_hash_0 = child_id_hash_0;
        const is_authorized_0 = _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
            { dup: { n: 0 } },
            { idx: { cached: false,
                    pushPath: false,
                    path: [
            ...
            { idx: { cached: false,
                    ...
                    path: [
                        { tag: 'value',
                            value: { value: _descriptor_0.toValue(disclosed_hash_0),
                                alignment: _descriptor_0.alignment() } }
                    ] } },
            { popeq: { cached: false,
                    result: undefined } }
        ]).value);
        return is_authorized_0;
    }
}
        ...
        consent_registry: {
            ...
            member(...args_0) {
                ...
                if (!(typeof (key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('member', 'argument 1', 'consent.compact line 8 char 1', 'Field', key_0);
                }
                return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
            ...
            lookup(...args_0) {
                ...
                const key_0 = args_0[0];
                if (!(typeof (key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('lookup', 'argument 1', 'consent.compact line 8 char 1', 'Field', key_0);
                }
                return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
