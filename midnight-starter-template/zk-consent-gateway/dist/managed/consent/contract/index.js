        ...
        this.circuits = {
            grant_consent: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('grant_consent', 'argument 1 (as invoked from Typescript)', 'consent.compact line 13 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(typeof (child_id_hash_0) === 'bigint' && child_id_hash_0 >= 0 && child_id_hash_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('grant_consent', 'argument 1 (argument 2 as invoked from Typescript)', 'consent.compact line 13 char 1', 'Field', child_id_hash_0);
                }
        ...
        consent_registry: {
            ...
            member(...args_0) {
                ...
                if (!(typeof (key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('member', 'argument 1', 'consent.compact line 7 char 1', 'Field', key_0);
                }
                return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
            ...
            lookup(...args_0) {
                ...
                const key_0 = args_0[0];
                if (!(typeof (key_0) === 'bigint' && key_0 >= 0 && key_0 <= __compactRuntime.MAX_FIELD)) {
                    __compactRuntime.typeError('lookup', 'argument 1', 'consent.compact line 7 char 1', 'Field', key_0);
                }
                return _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context, partialProofData, [
                    { dup: { n: 0 } },
                    { idx: { cached: false,
